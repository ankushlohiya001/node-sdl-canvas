...
export const KeyMod: Record<string, number> = {
  NONE: 0,
  LSHIFT: 1,
  RSHIFT: 2,
  LCTRL: 64,
...
export const Cursor: Record<string, number> = {
  ARROW: 0,
  /**< Arrow */
  IBEAM: 1,
  /**< I-beam */
...
export const BlendMode = {
  ...
  BLEND: 0x00000001, //< alpha blending dstRGB = (srcRGB * srcA) + (dstRGB * (1-srcA)) and dstA = srcA + (dstA * (1-srcA))
  ADD: 0x00000002, //< additive blending dstRGB = (srcRGB * srcA) + dstRGB and dstA = dstA
  MOD: 0x00000004, //< color modulate dstRGB = srcRGB * dstRGB and dstA = dstA
  MUL: 0x00000008, //< color multiply dstRGB = (srcRGB * dstRGB) + (dstRGB * (1-srcA)) and dstA = (srcA * dstA) + (dstA * (1-srcA))
  INVALID: 0x7fffffff,
};
